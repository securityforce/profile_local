...
/*******************************************************************************************/
	...
	$.fn.pajinate = function(options){
		...
		return this.each(function(){
			...
			$items.hide();
			// Show the first page			
			$items.slice(0, meta.data(items_per_page)).fadeIn('slow'); //changed from show
		...
		function goto(page_num){
			...
			//udfrance - height correction
				
			var c_height = $page_container.height()
			$page_container.css({height:c_height});
			
			// Hide the current page
			$items.fadeOut(400)
					.delay(300).slice(start_from, end_on)
					.delay(300).fadeIn(400);//changed from show
