...
(function($){
	...
	$(document).ready(function() {
		$('body').append('<div id="supersized-loader"></div><div id="supersized-logoLoader"></div><ul id="supersized"></ul>');
		
		//Hide content container at start  - added by UDFRANCE
		$('#nav-wrapper').hide();
		$('#content-wrapper').animate({top:'200px',opacity:0}, 0);
